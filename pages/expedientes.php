...
<input type="search" name="search_kwds" id="search_kwds" oninput="patient_search();" tabindex="0" results="10" placeholder="Nombre(s) y/o apellido(s)">
...
<fieldset>
	...
	<form name="expediente" action="?page=expedientes" method="post">
		<table class="noeffects">
			...
			<tr>
				<td>
					...
					<input type="text" name="patient[firstname]" id="firstname" placeholder="Nombre" required="required" tabindex="0" value="<?php if(isset($patient->firstname)) { echo $patient->firstname; } ?>">
				</td>
				<td>
					<label for="lastname">Apellido *</label><br>
					<input type="text" name="patient[lastname]" id="lastname" placeholder="Apellido" required="required" tabindex="0" value="<?php if(isset($patient->lastname)) { echo $patient->lastname; } ?>">
				</td>
				<td>
					<label for="gender">Género</label><br>
					<select name="patient[gender]" id="gender" tabindex="0">
				...
				<td>
					...
					<input type="number" name="patient[birthdate]" id="birthdate" size="5" tabindex="0" value="<?php if(isset($patient->birthdate)) { echo $patient->get_age(); } ?>">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					<label for="address">Dirección</label><br>
					<input type="text" name="patient[address]" id="address" placeholder="Dirección" style="width: 88%;" tabindex="0" value="<?php if(isset($patient->address)) { echo $patient->address; } ?>">
				</td>
				<td>
					<label for="phone">Teléfono</label><br>
					<input type="tel" name="patient[phone]" id="phone" placeholder="Teléfono" tabindex="0" value="<?php if(isset($patient->phone)) { echo $patient->phone; } ?>">
				</td>
			...
			<tr>
				<td colspan="2">
					...
					<textarea name="patient[comments]" id="comments" style="width: 88%; height: 100px;" tabindex="0" placeholder="Notas sobre el paciente"><?php if(isset($patient->comments)) { echo $patient->comments; } ?></textarea>
				</td>
				<td colspan="2">
					...
					<?php
						...
						if(empty($investigations)) {
							...
							echo '<select multiple name="investigations[]" id="investigations" style="width: 92%; height: 100px;" tabindex="0">', PHP_EOL;
		...
		<table id="record" class="noeffects">
			...
			<tr>
				<td colspan="2">
					...
					<input type="text" name="reference" id="reference" placeholder="Referencia" style="width: 88%;" tabindex="0" value="<?php if(isset($record->reference)) { echo $record->reference; } ?>">
				</td>
				<td colspan="2">
				</td>
			</tr>
			<tr>
				<td colspan="2">
					...
					<textarea name="motive" id="motive" style="width: 88%; height: 50px;" placeholder="Motivo" tabindex="0"><?php if(isset($record->motive)) { echo $record->motive; } ?></textarea>
				</td>
			</tr>
			<tr>
				<td>
					<label for="occupation">Ocupación</label><br>
					<input type="text" name="occupation" id="occupation" placeholder="Ocupación" tabindex="0" value="<?php if(isset($record->occupation)) { echo $record->occupation; } ?>">
				</td>
				<td>
					<label for="sport">Deporte</label><br>
					<input type="text" name="sport" id="sport" placeholder="Deporte" tabindex="0" value="<?php if(isset($record->sport)) { echo $record->sport; } ?>">
				</td>
				<td colspan="2">
					<label for="pc_usage">Uso de PC <em>(hrs/día)</em></label><br>
					<input type="number" name="pc_usage" id="pc_usage" placeholder="Horas" style="width: 80px;" min="0" max="24" tabindex="0" value="<?php if(isset($record->pc_usage)) { echo $record->pc_usage; } ?>">
				</td>
			</tr>
			<tr>
				<td>
					<label for="health">Estado de salud</label><br>
					<input type="text" name="health" id="health" placeholder="Estado de salud" tabindex="0" value="<?php if(isset($record->health)) { echo $record->health; } ?>">
				</td>
				<td colspan="3">
					<br>
					<input type="checkbox" name="has_diabetes" id="has_diabetes" value="1" tabindex="0" <?php if(isset($record->has_diabetes) && $record->has_diabetes) { echo 'checked'; } ?>><label for="has_diabetes">Diabetes</label><br>
					<input type="checkbox" name="has_hypertension" id="has_hypertension" value="1" tabindex="0" <?php if(isset($record->has_hypertension) && $record->has_hypertension) { echo 'checked'; } ?>><label for="has_hypertension">Hipertensión arteral</label><br>
					<input type="checkbox" name="has_glaucoma_history" id="has_glaucoma_history" value="1" tabindex="0" <?php if(isset($record->has_glaucoma_history) && $record->has_glaucoma_history) { echo 'checked'; } ?>><label for="has_glaucoma_history">Antecedentes familiares de glaucoma</label><br>
			...
			<tr>
				<td>
					...
					<input type="text" name="addictions" id="addictions" placeholder="Adicciones" tabindex="0" value="<?php if(isset($record->addictions)) { echo $record->addictions; } ?>">
				</td>
				<td>
					<div class="input-group">
						<label for="w_od">W:OD</label><br>
						<input type="text" name="w_od" id="w_od" placeholder="       (       %       [       " tabindex="0" value="<?php if(isset($record->w_od)) { echo $record->w_od; } ?>" oninput="format_odoi('#w_od');">
						<div class="input-addon">
							<input type="checkbox" id="w_reflect" tabindex="0" class="od_oi_reflection" data-origin="#w_od" data-target="#w_oi">
						</div>
					</div>
				</td>
			</tr>
			<tr>
				...
				<td>
					...
					<input type="text" name="w_oi" id="w_oi" placeholder="       (       %       [       " tabindex="0" value="<?php if(isset($record->w_oi)) { echo $record->w_oi; } ?>" oninput="format_odoi('#w_oi');" style="width: 82%;">
				</td>
			</tr>
			...
			<tr>
				<td>
					...
					<select name="av" id="av" tabindex="0">
				...
				<td><label for="od">AV OD</label><br><span style="font-size: 1.5em;">20/</span><input type="text" name="od" id="od" size="4" placeholder="" value="<?php if(isset($record->od)) { echo $record->od; } ?>" tabindex="0"></td>
				<td><label for="estenop_od">Estenop OD</label><br><span style="font-size: 1.5em;">20/</span><input type="text" name="estenop_od" id="estenop_od" size="4" placeholder="" value="<?php if(isset($record->estenop_od)) { echo $record->estenop_od; } ?>" tabindex="0"></td>
			</tr>
			<tr>
				<td>
					<label for="cover_test">Cover test</label><br><input type="text" name="cover_test" id="cover_test" placeholder="Cover test" value="<?php if(isset($record->cover_test)) { echo $record->cover_test; } ?>" tabindex="0">
					<br><br><input type="checkbox" name="pos_mirada" id="pos_mirada" tabindex="0" value="1" <?php if(isset($record->pos_mirada) && $record->pos_mirada) { echo 'checked'; } ?>><label for="pos_mirada">Posiciones mirada</label>
				</td>
				<td><label for="oi">AV OI</label><br><span style="font-size: 1.5em;">20/</span><input type="text" name="oi" id="oi" size="4" placeholder="" value="<?php if(isset($record->oi)) { echo $record->oi; } ?>" tabindex="0"></td>
				<td><label for="estenop_oi">Estenop OI</label><br><span style="font-size: 1.5em;">20/</span><input type="text" name="estenop_oi" id="estenop_oi" size="4" placeholder="" value="<?php if(isset($record->estenop_oi)) { echo $record->estenop_oi; } ?>" tabindex="0"></td>
				</tr>
			<tr>
				<td>
					<div class="input-group">
						<label for="m_od">M:OD</label><br>
						<input type="text" name="m_od" id="m_od" placeholder="       (       %       [       " value="<?php if(isset($record->m_od)) { echo $record->m_od; } ?>" oninput="format_odoi('#m_od');" tabindex="0">
						<div class="input-addon">
							<input type="checkbox" id="m_reflect" tabindex="0" class="od_oi_reflection" data-origin="#m_od" data-target="#m_oi">
						</div>
					</div>
				</td>
				...
				<td>
					...
					<input type="text" name="j" id="j" size="1" placeholder="" value="<?php if(isset($record->j)) { echo $record->j; } ?>" tabindex="0">
				</td>
				<td rowspan="2">
					...
					<table>
						...
						<tr>
							<td colspan="2"><input type="text" name="flash_od_vert" id="flash_od_vert" size="3" value="<?php if(isset($record->flash_od_vert)) { echo $record->flash_od_vert; } ?>" tabindex="0"></td>
							<td colspan="2"><input type="text" name="flash_oi_vert" id="flash_oi_vert" size="3" value="<?php if(isset($record->flash_oi_vert)) { echo $record->flash_oi_vert; } ?>" tabindex="0"></td>
						...
						<tr>
							...
							<td><input type="text" name="flash_od_horiz" id="flash_od_horiz" size="3" value="<?php if(isset($record->flash_od_horiz)) { echo $record->flash_od_horiz; } ?>" tabindex="0"></td>
							<td style="padding-left: 10px; vertical-align: middle; text-align: center;"><img src="resources/img/flashes-separator.png" height="20" width="20"></td>
							<td><input type="text" name="flash_oi_horiz" id="flash_oi_horiz" size="3" value="<?php if(isset($record->flash_oi_horiz)) { echo $record->flash_oi_horiz; } ?>" tabindex="0"></td>
			...
			<tr>
				<td>
					...
					<input type="text" name="m_oi" id="m_oi" placeholder="       (       %       [       " value="<?php if(isset($record->m_oi)) { echo $record->m_oi; } ?>" oninput="format_odoi('#m_oi');" tabindex="0">
				</td>
				<td>
					<label for="j_prim">J'</label><br>
					<input type="text" name="j_prim" id="j_prim" size="1" placeholder="" value="<?php if(isset($record->j_prim)) { echo $record->j_prim; } ?>" tabindex="0">
				</td>
			</tr>
			<tr>
				<td>
					<label for="cv_od">CV:OD</label><br>
					<span style="font-size: 1.5em;">20/</span><input type="text" name="cv_od" id="cv_od" size="4" placeholder="" value="<?php if(isset($record->cv_od)) { echo $record->cv_od; } ?>" tabindex="0">
				</td>
				<td>
					<div class="input-group">
						<label for="k_od">K:OD</label><br>
						<input type="text" name="k_od" id="k_od" size="15" placeholder="        /        x        " value="<?php if(isset($record->k_od)) { echo $record->k_od; } ?>" oninput="format_k('#k_od');" tabindex="0" style="width: 43%;">
						<div class="input-addon">
							<input type="checkbox" id="k_reflect" tabindex="0" class="od_oi_reflection" data-origin="#k_od" data-target="#k_oi">
						</div>
			...
			<tr>
				<td>
					...
					<span style="font-size: 1.5em;">20/</span><input type="text" name="cv_oi" id="cv_oi" size="4" placeholder="" value="<?php if(isset($record->cv_oi)) { echo $record->cv_oi; } ?>" tabindex="0">
				</td>
				<td>
					<label for="k_od">K:OI</label><br>
					<input type="text" name="k_oi" id="k_oi" size="15" placeholder="        /        x        " value="<?php if(isset($record->k_oi)) { echo $record->k_oi; } ?>" oninput="format_k('#k_oi');" tabindex="0">
					<span><?php if(isset($record->k_oi)) { echo $record->k_eval('k_oi'); } ?></span>
				</td>
				<td>
					<label for="lectura">Lectura (Palabras por minuto)</label><br>
					<input type="text" name="lectura" id="lectura" placeholder="Lectura" value="<?php if(isset($record->lectura)) { echo $record->lectura; } ?>" tabindex="0">
				</td>
				<td>
			...
			<tr>
				<td colspan="2">
					...
					<textarea name="observaciones" id="observaciones" style="width: 88%; height: 78px;" tabindex="0" placeholder="Notas sobre la visita"><?php if(isset($record->observaciones)) { echo $record->observaciones; } ?></textarea>
				</td>
				<td colspan="2">
					<label for="recomendaciones">Recomendaciones</label><br>
					<textarea name="recomendaciones" id="recomendaciones" style="width: 88%; height: 78px;" tabindex="0" placeholder="Se recomienda..."><?php if(isset($record->recomendaciones)) { echo $record->recomendaciones; } ?></textarea>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					...
					<input type="text" name="conversion_dv" id="conversion_dv" placeholder="          /          " value="<?php if(isset($record->conversion_dv)) { echo $record->conversion_dv; } ?>" oninput="format_twonum('#conversion_dv');" tabindex="0">
				</td>
				<td>
					<label for="tipo_lc">Tipo LC</label><br>
					<input type="text" name="tipo_lc" id="tipo_lc" placeholder="Tipo LC" value="<?php if(isset($record->tipo_lc)) { echo $record->tipo_lc; } ?>" tabindex="0">
				</td>
			</tr>
			<tr>
			...
			<tr>
				<td>
					...
					<input type="text" name="amplitud_acomodacion" id="amplitud_acomodacion" placeholder="Amplitud de acomodación" value="<?php if(isset($record->amplitud_acomodacion)) { echo $record->amplitud_acomodacion; } ?>" tabindex="0"><br>
					<span class="small">Referencia: monoc / (100/cm) / 15-.25 (edad)</span>
				</td>
				<td>
					<label for="acomodacion_relativa">Acomodación relativa</label><br>
					<input type="text" name="acomodacion_relativa" id="acomodacion_relativa" placeholder="          /          " value="<?php if(isset($record->acomodacion_relativa)) { echo $record->acomodacion_relativa; } ?>" oninput="format_twonum('#acomodacion_relativa');" tabindex="0"><br>
					<span class="small">Referencia: (+250 / -350)</span>
				</td>
				<td>
					<label for="retardo_acomodativo">Retardo acomodativo</label><br>
					<input type="text" name="retardo_acomodativo" id="retardo_acomodativo" placeholder="Retardo acomodativo" value="<?php if(isset($record->retardo_acomodativo)) { echo $record->retardo_acomodativo; } ?>" tabindex="0"><br>
					<span class="small">Referencia: cerca +050 &gt; lejos</span>
				</td>
				<td>
					<label for="ppc">PPC</label><br>
					<input type="number" name="ppc" id="ppc" placeholder="PPC" value="<?php if(isset($record->ppc)) { echo $record->ppc; } ?>" tabindex="0"><br>
			...
			<tr>
				<td>
					...
					<input type="number" name="tonometria_od" id="tonometria_od" placeholder="Tonometría OD" tabindex="0" value="<?php if(isset($record->tonometria_od)) { echo $record->tonometria_od; } ?>" step="any">
				</td>
				<td rowspan="2">
					<label for="pccc">Párpados, córnea, conjuntiva, y cristalino</label><br>
					<textarea name="pccc" id="pccc" placeholder="Párpados, córnea, conjuntiva, y cristalino" tabindex="0" style="width: 220px; height: 88px;"><?php if(isset($record->pccc)) { echo $record->pccc; } ?></textarea>
				</td>
				<td rowspan="4">
					<label for="sensib_contraste">Sensibilidad de contraste</label><br>
					<input type="text" name="sensib_contraste" id="sensib_contraste" placeholder="           /" value="<?php if(isset($record->sensib_contraste)) { echo $record->sensib_contraste; } ?>" size="7" tabindex="0"><br>
					<input type="checkbox" class="ocular" name="has_vision_cromatica" id="has_vision_cromatica" value="1" tabindex="0" <?php if(isset($record->has_vision_cromatica) && $record->has_vision_cromatica) { echo 'checked'; } ?>><label for="has_vision_cromatica">Visión cromática</label><br>
					<div class="occular_options" id="radio_has_vision_cromatica" <?php if(isset($record->has_vision_cromatica) && $record->has_vision_cromatica) { echo 'style="display: block;"'; } ?>>
						<input type="radio" name="vision_cromatica" id="vision_cromatica_yes" value="1" tabindex="0" <?php if(isset($record->has_vision_cromatica) && $record->has_vision_cromatica == 1) { echo 'checked="checked"'; } ?>><label for="vision_cromatica_yes">Si</label>
						<input type="radio" name="vision_cromatica" id="vision_cromatica_no" value="2" tabindex="0" <?php if(isset($record->has_vision_cromatica) && $record->has_vision_cromatica == 2) { echo 'checked="checked"'; } ?>><label for="vision_cromatica_no">No</label>
					</div>
					<input type="checkbox" class="ocular" name="has_confrontacion" id="has_confrontacion" value="1" tabindex="0" <?php if(isset($record->has_confrontacion) && $record->has_confrontacion) { echo 'checked'; } ?>><label for="has_confrontacion">Confrontación</label><br>
					<div class="occular_options" id="radio_has_confrontacion" <?php if(isset($record->has_confrontacion) && $record->has_confrontacion) { echo 'style="display: block;"'; } ?>>
						<input type="radio" name="confrontacion" id="confrontacion_yes" value="1" tabindex="0" <?php if(isset($record->has_confrontacion) && $record->has_confrontacion == 1) { echo 'checked="checked"'; } ?>><label for="confrontacion_yes">Si</label>
						<input type="radio" name="confrontacion" id="confrontacion_no" value="2" tabindex="0" <?php if(isset($record->has_confrontacion) && $record->has_confrontacion == 2) { echo 'checked="checked"'; } ?>><label for="confrontacion_yes">No</label>
					</div>
					<input type="checkbox" class="ocular" name="has_arco_senil" id="has_arco_senil" value="1" tabindex="0" <?php if(isset($record->has_arco_senil) && $record->has_arco_senil) { echo 'checked'; } ?>><label for="has_arco_senil">Arco senil</label><br>
					<div class="occular_options" id="radio_has_arco_senil" <?php if(isset($record->has_arco_senil) && $record->has_arco_senil) { echo 'style="display: block;"'; } ?>>
						<input type="radio" name="arco_senil" id="arco_senil_yes" value="1" tabindex="0" <?php if(isset($record->has_arco_senil) && $record->has_arco_senil == 1) { echo 'checked="checked"'; } ?>><label for="arco_senil_yes">Si</label>
						<input type="radio" name="arco_senil" id="arco_senil_no" value="2" tabindex="0" <?php if(isset($record->has_arco_senil) && $record->has_arco_senil == 2) { echo 'checked="checked"'; } ?>><label for="arco_senil_no">No</label>
					</div>
					<input type="checkbox" class="ocular" name="has_amsler" id="has_amsler" value="1" tabindex="0" <?php if(isset($record->has_amsler) && $record->has_amsler) { echo 'checked'; } ?>><label for="has_amsler" >Amsler</label><br>
					<div class="occular_options" id="radio_has_amsler" <?php if(isset($record->has_amsler) && $record->has_amsler) { echo 'style="display: block;"'; } ?>>
						<input type="radio" name="amsler" id="amsler_yes" value="1" tabindex="0" <?php if(isset($record->has_amsler) && $record->has_amsler == 1) { echo 'checked="checked"'; } ?>><label for="amsler_yes">Si</label>
						<input type="radio" name="amsler" id="amsler_no" value="2" tabindex="0" <?php if(isset($record->has_amsler) && $record->has_amsler == 2) { echo 'checked="checked"'; } ?>><label for="amsler_no">No</label>
					</div>
				</td>
				<td>
					<label for="disco">Disco óptico</label><br>
					<input type="text" name="disco" id="disco" placeholder="Aspecto del disco" value="<?php if(isset($record->disco)) { echo $record->disco; } ?>" tabindex="0"><br>
			...
			<tr>
				<td>
					...
					<input type="number" step="any" name="tonometria_oi" id="tonometria_oi" placeholder="Tonometría OI" tabindex="0" value="<?php if(isset($record->tonometria_oi)) { echo $record->tonometria_oi; } ?>">
				</td>
				<td>
					<label for="opacidades">Opacidades</label><br>
					<input type="text" name="opacidades" id="opacidades" placeholder="Opacidades" value="<?php if(isset($record->opacidades)) { echo $record->opacidades; } ?>" tabindex="0">
				</td>
			</tr>
			<tr>
				<td colspan="3"></td>
				<td>
					...
					<input type="number" name="pantalla_tangente" id="pantalla_tangente" placholder="Pantalla tangente" value="<?php if(isset($record->pantalla_tangente)) { echo $record->pantalla_tangente; } ?>" tabindex="0">
				</td>
			</tr>
			<tr>
				<td colspan="3"></td>
				<td>
					<input type="checkbox" class="ocular" name="pupilas_selector" id="pupilas_selector" <?php if(isset($record->pupilas_redondas) && $record->pupilas_redondas) { echo 'checked'; } ?> tabindex="0">
					...
					<div class="occular_options" id="radio_pupilas_selector" <?php if(isset($record->pupilas_redondas) && $record->pupilas_redondas) { echo ' style="display: block;"'; } ?>>
								...
								<input type="radio" name="pupilas_redondas" id="pupilas_redondas_yes" value="1" tabindex="0" <?php if(isset($record->pupilas_redondas) && $record->pupilas_redondas == 1) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_redondas_yes">Si</label>
						<input type="radio" name="pupilas_redondas" id="pupilas_redondas_no" value="2" tabindex="0" <?php if(isset($record->pupilas_redondas) && $record->pupilas_redondas == 2) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_redondas_no">No</label>
						<br>


						<label>Iguales</label><br>
						<input type="radio" name="pupilas_iguales" id="pupilas_iguales_yes" value="1" tabindex="0" <?php if(isset($record->pupilas_iguales) && $record->pupilas_iguales == 1) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_iguales_yes">Si</label>
						<input type="radio" name="pupilas_iguales" id="pupilas_iguales_no" value="2" tabindex="0" <?php if(isset($record->pupilas_iguales) && $record->pupilas_iguales == 2) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_iguales_no">No</label>
						<br>
	
						<label>Responden a la luz</label><br>
						<input type="radio" name="pupilas_luz" id="pupilas_luz_yes" value="1" tabindex="0" <?php if(isset($record->pupilas_luz) && $record->pupilas_luz == 1) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_luz_yes">Si</label>
						<input type="radio" name="pupilas_luz" id="pupilas_luz_no" value="2" tabindex="0" <?php if(isset($record->pupilas_luz) && $record->pupilas_luz == 2) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_luz_no">No</label>
						<br>
	
						<label>Responden a la acomodación</label><br>
						<input type="radio" name="pupilas_acomodacion" id="pupilas_acomodacion_yes" value="1" tabindex="0" <?php if(isset($record->pupilas_acomodacion) && $record->pupilas_acomodacion == 1) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_acomodacion_no">Si</label>
						<input type="radio" name="pupilas_acomodacion" id="pupilas_acomodacion_no" value="2" tabindex="0" <?php if(isset($record->pupilas_acomodacion) && $record->pupilas_acomodacion == 2) { echo 'checked="checked"'; } ?>>
						<label for="pupilas_acomodacion_no">No</label>
					</div>
					<input type="checkbox" class="ocular" name="okp_selector" id="okp" value="1" tabindex="0" <?php if(isset($record->okp) && $record->okp) { echo 'checked'; } ?>><label for="okp" >OKP</label><br>
		...
		<br>
		<input type="submit" name="btn_submit" id="btn_submit" value="Almacenar datos" class="floatright" tabindex="0">
		<?php if(isset($patient)) { ?>
